...
const { MAX_PLAYERS, MIN_NAME_LENGTH } = require('./rules');
...
//
// The "never an entirely botted table" rule is not here - it is enforced one step
// earlier, when the setting is sanitized, because the ceiling there (MAX_PLAYERS - 1)
// is about what a host may ask for. This is only about what fits.
